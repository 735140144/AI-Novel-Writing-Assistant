export const queryKeys = {
  ...
  settings: {
    ...
    systemEmail: ["settings", "system-email"] as const,
    ...
    billingModelPrices: ["settings", "billing", "model-prices"] as const,
    billingPackageTemplates: ["settings", "billing", "package-templates"] as const,
    billingRedeemCodes: ["settings", "billing", "redeem-codes"] as const,
  },
  wallet: {
    summary: ["wallet", "summary"] as const,
    dailyUsage: (days: number) => ["wallet", "daily-usage", days] as const,
    redeemHistory: ["wallet", "redeem-history"] as const,
  },
  novelsKnowledge: {
