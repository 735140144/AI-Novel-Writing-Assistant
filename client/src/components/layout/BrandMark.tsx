...
export default function BrandMark({ className }: BrandMarkProps) {
  return (
    ...
    >
      <defs>
        <linearGradient id="brandMarkGradientReact" x1="14" y1="12" x2="82" y2="84" gradientUnits="userSpaceOnUse">
          <stop stopColor="#1A5F7A" />
          <stop offset="1" stopColor="#122033" />
        </linearGradient>
      </defs>
      <rect x="8" y="8" width="80" height="80" rx="24" fill="url(#brandMarkGradientReact)" />
