...
发布能力应进入小说工作台中靠近成书完成后的环节，而不是隐藏在系统设置里。
...
* 前端相关入口：`client/src/pages/novels/components/NovelEditView.tsx`、`client/src/pages/novels/novelWorkspaceNavigation.ts`、`client/src/api/client.ts`。
